        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="mb-5 flex items-center justify-between">
            <label htmlFor="" className='text-headingColor font-bold text-[16px] leading-7'>
              Are you a:
              <select name="role" value={formData.role} className='text-textColor font-semibold text-[15px] leading-7 px-4
              py-3 focus:outline-none' id="" onChange={handleInputChange}>
            ...
            <label htmlFor="" className='text-headingColor font-bold text-[16px] leading-7'>
              ...
              py-3 focus:outline-none' id="" onChange={handleInputChange} value={formData.gender}>
