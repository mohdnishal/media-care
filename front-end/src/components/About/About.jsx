    ...
    <section>
        ...
        <div className="container">
            ...
            <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
                ...
                <p className='text_para'>For 30 year in a row,U.S. News& World Report has recognized us
                one of the best publics hospitals in the Nation  and #1 in Texas. Lorem ipsum dolor sit amet..
                 </p>
                 <p className='text_para mt-[30px]'>
                    Our best is something we strive for each day.caring of our patients-not 
